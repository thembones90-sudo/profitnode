...
(() => {
  ...
  out.push(['MY RIG renders the canonical tier on every loadout card', canonPage.indexOf('pn-tier-artifact') > -1 && canonPage.indexOf('pn-tier-epic') > -1 && canonPage.indexOf('pn-tier-legendary') > -1 && canonPage.indexOf('pn-tier-rare') > -1]);
  out.push(['MY RIG overall rig class is REAPER, decoupled from stale rig profile logic', canonPage.indexOf('OVERALL RIG CLASS</span><span class="chip pn-tier-legendary">LEGENDARY') > -1]);
