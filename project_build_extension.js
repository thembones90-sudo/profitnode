...
function pbCompatHtml(project){
  ...
  return'<div class="panel" data-pb-compat style="margin-top:8px"><div class="panel-head"><h2>COMPATIBILITY CHECK</h2><span class="chip '+v.chip+'">'+v.word+" — "+model.verdict+'</span></div><div class="panel-body"><div class="pn-integrity-list">'+rows+"</div></div></div>"
}
