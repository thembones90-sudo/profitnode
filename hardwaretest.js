...
const results = env.run(sandbox, `(() => {
  ...
  out.push(['PARTS VAULT tier is conveyed by name color alone, no redundant tier-word pill', !pvHtml.includes('pn-inv-tier-chip')&&pvHtml.includes('<span class="pn-part-name pn-part-name-rare"')]);
