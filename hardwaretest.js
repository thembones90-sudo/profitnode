...
const results = env.run(sandbox, `(() => {
  ...
  out.push(['canonical tier order preserved', PN_GEAR_TIERS.join('>')==='HUSK>MERC>VANGUARD>N7>SPECTRE>REAPER>LEVIATHAN']);
  ...
  out.push(['active AM5 tiers match the PN tier mapping', canonicalHardware.cpus.filter(c=>c.platform==='AM5'&&c.availability_status==='RELEASED').every(c=>Math.floor(c.pn_score/2)>=0&&(c.pn_tier==='HUSK'||c.pn_tier==='MERC'||c.pn_tier==='VANGUARD'||c.pn_tier==='N7'||c.pn_tier==='SPECTRE'||c.pn_tier==='REAPER'||c.pn_tier==='LEVIATHAN'))]);
  out.push(['AM5 tier boundaries honor the canonical scale', canonicalHardware.cpus.filter(c=>c.platform==='AM5'&&c.availability_status==='RELEASED').every(c=>{const s=c.pn_score;const t=c.pn_tier;return(t==='LEVIATHAN'&&s>=97&&s<=100)||(t==='REAPER'&&s>=88&&s<97)||(t==='SPECTRE'&&s>=75&&s<88)||(t==='N7'&&s>=60&&s<75)||(t==='VANGUARD'&&s>=45&&s<60)||(t==='MERC'&&s>=30&&s<45)||(t==='HUSK'&&s>=0&&s<30)})]);
  ...
  out.push(['AM5 registry exposes the canonical gameplay anchors', canonicalHardware.cpus.find(c=>c.model==='Ryzen 7 7800X3D').pn_score===91&&canonicalHardware.cpus.find(c=>c.model==='Ryzen 7 7800X3D').pn_tier==='REAPER']);
  ...
  out.push(['3600 + RTX 2060 + B450 is REVENANT', ex1.tier==='VANGUARD']);
  out.push(['5600 + RX 6700 XT + B550 is GHOUL', ex2.tier==='N7']);
  out.push(['5700X3D + RTX 3080 + X570 is ALGHOUL', ex3.tier==='SPECTRE']);
  out.push(['2600 + GTX 1070 is REVENANT', ex4.tier==='VANGUARD']);
  out.push(['5800X3D + RX 580 is not ALGHOUL', bad.tier!=='SPECTRE']);
  ...
  out.push(['search result separates performance and tier badges', searching.includes('pn-result-rating')&&searching.includes('pn-result-tier pn-tier-vanguard')]);
  ...
  out.push(['selected part carries its canonical tier color class', editor.includes('pn-tier-pill pn-tier-vanguard')]);
  ...
  out.push(['DDR4 3600 CL16 follows canonical formula without brand/RGB bonus', ram3600.overall===84&&ram3600.tier==='SPECTRE']);
  ...
  out.push(['every ASUS AM5 board resolves to a valid tier', ['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].every(t=>asusAm5.some(b=>b.pn_tier===t))||asusAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier))]);
  ...
  out.push(['ASUS high-tier boards land REAPER, entry boards stay below', catalogFind('MOBO','ASUS ROG CROSSHAIR X870E GLACIAL').pn_tier==='REAPER'&&catalogFind('MOBO','ASUS PRIME A620M-K').pn_tier!=='ALGHOUL'&&catalogFind('MOBO','ASUS ROG CROSSHAIR X870E HERO').pn_score>=80]);
  ...
  out.push(['every MSI AM5 board resolves to a valid tier on a valid chipset', msiAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X870','B850','B840','B650E','B650','X670E','X670','A620'].includes(b.chipset)&&b.pn_tier!==b.chipset)]);
  ...
  out.push(['MSI flagships land REAPER while entry boards stay below', catalogFind('MOBO','MSI MEG X870E GODLIKE').pn_tier==='REAPER'&&catalogFind('MOBO','MSI MEG X870E GODLIKE').pn_score>=85&&catalogFind('MOBO','MSI PRO A620M-B').pn_tier!=='ALGHOUL'&&catalogFind('MOBO','MSI MAG B650 TOMAHAWK WIFI').pn_score>=75]);
  ...
  out.push(['every Gigabyte AM5 board resolves to a valid tier on a valid chipset', gigAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X870','B850','B840','B650E','B650','X670E','X670','A620'].includes(b.chipset)&&b.pn_tier!==b.chipset)]);
  ...
  out.push(['Gigabyte flagships land REAPER while entry boards stay below', catalogFind('MOBO','Gigabyte X870E AORUS XTREME AI TOP').pn_tier==='REAPER'&&catalogFind('MOBO','Gigabyte X870E AORUS XTREME AI TOP').pn_score>=85&&catalogFind('MOBO','Gigabyte A620M H').pn_tier!=='ALGHOUL'&&catalogFind('MOBO','Gigabyte B650 AORUS ELITE AX').pn_score>=75]);
  ...
  out.push(['every ASRock AM5 board resolves to a valid tier on a valid chipset', asrockAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X870','B850','B650E','B650','A620','A620A'].includes(b.chipset)&&b.pn_tier!==b.chipset)]);
  ...
  out.push(['ASRock flagships land REAPER while entry boards stay below', catalogFind('MOBO','ASRock X870E Nova WiFi').pn_tier==='REAPER'&&catalogFind('MOBO','ASRock X870E Nova WiFi').pn_score>=85&&catalogFind('MOBO','ASRock A620M Pro RS WiFi').pn_tier!=='ALGHOUL']);
  ...
  out.push(['every NZXT AM5 board resolves to a valid tier on a valid chipset', nzxtAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X870','B850','B650E','B650','A620','A620A'].includes(b.chipset)&&b.pn_tier!==b.chipset)]);
  ...
  out.push(['every Biostar AM5 board resolves to a valid tier on a valid chipset', biostarAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X670E','X670','B850','B840','B650E','B650','A620A','A620'].includes(b.chipset))]);
  ...
  out.push(['every Colorful AM5 board resolves to a valid tier on a valid chipset', colorfulAm5.every(b=>['HUSK','MERC','VANGUARD','N7','SPECTRE','REAPER','LEVIATHAN'].includes(b.pn_tier)&&['X870E','X870','B850','B650','A620'].includes(b.chipset))]);
  ...
  out.push(['DDR5 6000 MT/s scores as top-tier in ramRating', ramRating({technology:'DDR5',moduleCount:2,perModuleCapacity:16,totalCapacity:32,speed:6000,casLatency:30}).tier==='REAPER']);
  ...
  out.push(['AM5 build resolves REAPER tier with RTX 5070 Ti', !!(am5Profile.complete&&am5Profile.tierIndex>=5)]);
