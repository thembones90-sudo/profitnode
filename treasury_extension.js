...
function pnTreasuryCalculate(e){
  ...
  const liquid=sum(t.balances,e=>e.include!==!1),obligations=sum(t.obligations,e=>"PAID"!==e.status),pending=sum(t.pendingAssets,e=>!e.converted),income=sum(t.incomes,()=>!0),fortress=liquid,afterObligations=liquid-obligations;
