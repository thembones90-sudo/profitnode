...
function renderTreasury(){
  ...
  const cards=pnTreasuryHero(t,e,a)
    ...
    +pnTreasuryCard("Projected Hoard",pnTreasuryMoney(t.afterSalary),"Fortress + spoils + tribute","is-projected","rune");
...
(function(){
  ...
  @media(max-width:760px){.pn-treasury-grid{grid-template-columns:1fr}.pn-treasury-strip{flex-wrap:wrap}.pn-treasury-settings{grid-template-columns:1fr}.pn-treasury-row{grid-template-columns:1fr!important}.pn-treasury-remove{grid-column:1}.pn-wc-chronicle-entry{grid-template-columns:1fr}.pn-wc-ledger-row{grid-template-columns:1fr}}
