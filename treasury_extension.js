...
(function(){
  ...
  .btn.pn-wc-btn{background:linear-gradient(180deg,var(--wc-panel-2),var(--wc-bg));border:1px solid var(--wc-violet-dim);color:var(--wc-text);clip-path:polygon(8px 0,100% 0,100% calc(100% - 8px),calc(100% - 8px) 100%,0 100%,0 8px);transition:box-shadow .15s,border-color .15s}
  .btn.pn-wc-btn:hover{border-color:var(--wc-violet);box-shadow:0 0 14px var(--wc-glow-violet);color:var(--wc-text)}
